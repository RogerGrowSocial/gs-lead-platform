...
WITH invoice_data AS (
  SELECT * FROM (
    ...
    ('GS-0450', '2023-07-27'::date, '2023-08-10'::date, 'Best Bottles B.V.', 834.9, 0, 'paid', 'ORD-20230727', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 690.0, "has_vat": true, "subtotal": 690.0, "vat_amount": 144.89999999999998, "total": 834.9}]$$::jsonb),
    ('GS-0451', '2023-07-27'::date, '2023-08-10'::date, 'Best Bottles B.V.', 484.0, 0, 'paid', 'ORD-20230727', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 400.0, "has_vat": true, "subtotal": 400.0, "vat_amount": 84.0, "total": 484.0}]$$::jsonb),
    ...
    ('GS-0455', '2023-07-30'::date, '2023-08-13'::date, 'Werken bij The Workspot', 1185.8, 0, 'paid', 'ORD-20230730', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 980.0, "has_vat": true, "subtotal": 980.0, "vat_amount": 205.79999999999995, "total": 1185.8}]$$::jsonb),
    ...
    ('GS-0460', '2023-08-31'::date, '2023-09-14'::date, 'Werken bij The Workspot', 1185.8, 0, 'paid', 'ORD-20230831', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 980.0, "has_vat": true, "subtotal": 980.0, "vat_amount": 205.79999999999995, "total": 1185.8}]$$::jsonb),
    ...
    ('GS-0463', '2023-09-13'::date, '2023-09-27'::date, 'Best Bottles B.V.', 484.0, 0, 'paid', 'ORD-20230913', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 400.0, "has_vat": true, "subtotal": 400.0, "vat_amount": 84.0, "total": 484.0}]$$::jsonb),
    ('GS-0464', '2023-09-13'::date, '2023-09-27'::date, 'Best Bottles B.V.', 907.5, 0, 'paid', 'ORD-20230913', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": true, "subtotal": 750.0, "vat_amount": 157.5, "total": 907.5}]$$::jsonb),
    ...
    ('GS-0474', '2023-10-27'::date, '2023-11-10'::date, 'Best Bottles B.V.', 907.5, 0, 'paid', 'ORD-20231027', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": true, "subtotal": 750.0, "vat_amount": 157.5, "total": 907.5}]$$::jsonb),
    ('GS-0475', '2023-11-02'::date, '2023-11-16'::date, 'Best Bottles B.V.', 907.5, 0, 'cancelled', 'ORD-20231102', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": false, "subtotal": 750.0, "vat_amount": 0, "total": 907.5}]$$::jsonb),
    ...
    ('GS-0478', '2023-11-23'::date, '2023-12-07'::date, 'Werken bij The Workspot', 964.98, 0, 'paid', 'ORD-20231123', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 797.5, "has_vat": true, "subtotal": 797.5, "vat_amount": 167.48000000000002, "total": 964.98}]$$::jsonb),
    ('GS-0482', '2023-11-29'::date, '2023-12-13'::date, 'Klusbedrijf Sluijter', 605.0, 0, 'paid', 'ORD-20231129', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 500.0, "has_vat": true, "subtotal": 500.0, "vat_amount": 105.0, "total": 605.0}]$$::jsonb),
    ...
    ('GS-0488', '2024-01-04'::date, '2024-01-18'::date, 'Klusbedrijf Sluijter', 907.5, 0, 'paid', 'ORD-20240104', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": true, "subtotal": 750.0, "vat_amount": 157.5, "total": 907.5}]$$::jsonb),
    ('GS-0489', '2024-01-05'::date, '2024-01-19'::date, 'Tofiek', 1566.95, 0, 'paid', 'ORD-20240105', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 1295.0, "has_vat": true, "subtotal": 1295.0, "vat_amount": 271.95000000000005, "total": 1566.95}]$$::jsonb),
    ...
    ('GS-0501', '2024-02-18'::date, '2024-03-03'::date, 'Best Bottles B.V.', 907.5, 0, 'paid', 'ORD-20240218', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": true, "subtotal": 750.0, "vat_amount": 157.5, "total": 907.5}]$$::jsonb),
    ('GS-0506', '2024-03-12'::date, '2024-03-26'::date, 'Klusbedrijf Sluijter', 907.5, 0, 'paid', 'ORD-20240312', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": true, "subtotal": 750.0, "vat_amount": 157.5, "total": 907.5}]$$::jsonb),
    ('GS-0507', '2024-03-12'::date, '2024-03-26'::date, 'Best Bottles B.V.', 907.5, 0, 'paid', 'ORD-20240312', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": true, "subtotal": 750.0, "vat_amount": 157.5, "total": 907.5}]$$::jsonb),
    ('GS-0508', '2024-03-18'::date, '2024-04-01'::date, 'Werken bij The Workspot', 1548.8, 0, 'paid', 'ORD-20240318', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 1280.0, "has_vat": true, "subtotal": 1280.0, "vat_amount": 268.79999999999995, "total": 1548.8}]$$::jsonb),
    ('GS-0509', '2024-03-18'::date, '2024-04-01'::date, 'Tofiek', 1185.8, 0, 'paid', 'ORD-20240318', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 980.0, "has_vat": true, "subtotal": 980.0, "vat_amount": 205.79999999999995, "total": 1185.8}]$$::jsonb),
    ('GS-0513', '2024-03-18'::date, '2024-04-01'::date, 'Best Bottles B.V.', 907.5, 0, 'cancelled', 'ORD-20240318', $$[{"description": "Dienstverlening", "quantity": 1, "unit_price": 750.0, "has_vat": false, "subtotal": 750.0, "vat_amount": 0, "total": 907.5}]$$::jsonb)
  ) AS t(
    invoice_number,
    invoice_date,
    due_date,
